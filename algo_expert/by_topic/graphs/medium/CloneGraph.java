...
public class CloneGraph {
    ...
    private static Node clone(Node node, Map<Integer, Node> cloned) {
        ...
        for (Node neighbor: node.neighbors) {
            if (!cloned.containsKey(neighbor.val)) {
                childrenNodes.add(clone(neighbor, cloned));
            }
        }
        clonedNode.neighbors = childrenNodes;
        return clonedNode;
    }
